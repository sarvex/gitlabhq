...
gem 'fog-core', '= 2.1.0'
gem 'fog-google', '~> 1.22', require: 'fog/google'
gem 'fog-local', '~> 0.8'
# NOTE:
...
gem 'google-apis-compute_v1', '~> 0.61.0'
gem 'google-apis-container_v1', '~> 0.44.0'
gem 'google-apis-container_v1beta1', '~> 0.43.0'
gem 'google-apis-cloudbilling_v1', '~> 0.22.0'
gem 'google-apis-cloudresourcemanager_v1', '~> 0.31.0'
gem 'google-apis-iam_v1', '~> 0.39.0'
gem 'google-apis-serviceusage_v1', '~> 0.28.0'
gem 'google-apis-sqladmin_v1beta4', '~> 0.42.0'
...
gem 'flipper-active_support_cache_store', '~> 0.25.4'
gem 'unleash', '~> 3.2.2'
